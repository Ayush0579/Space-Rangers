class Level3 {
    ...
    start(){
        ...
        this.body1 = Bodies.circle(1078, -500, 100, {isStatic: false});
        this.body2 = Bodies.circle(1775, -2500, 100, {isStatic: false});
        this.body3 = Bodies.circle(2490, -4500, 100, {isStatic: false});
        this.body4 = Bodies.circle(1770, -6500, 100, {isStatic: false});
        this.body5 = Bodies.circle(2852, -8500, 100, {isStatic: false});
        this.body6 = Bodies.circle(1937, -10500, 100, {isStatic: false});
        this.body7 = Bodies.circle(236, -12500, 100, {isStatic: false});
        this.body8 = Bodies.circle(635, -14500, 100, {isStatic: false});
        this.body9 = Bodies.circle(1073, -16500, 100, {isStatic: false});
        this.body10 = Bodies.circle(1641, -18500, 100, {isStatic: false});
        this.body11 = Bodies.circle(1483, -20500, 100, {isStatic: false});
        this.body12 = Bodies.circle(3491, -22500, 100, {isStatic: false});
        this.body13 = Bodies.circle(290, -24500, 100, {isStatic: false});
        this.body14 = Bodies.circle(2655, -26500, 100, {isStatic: false});
        this.body15 = Bodies.circle(1238, -28500, 100, {isStatic: false});
        this.body16 = Bodies.circle(1764, -30500, 100, {isStatic: false});
        this.body17 = Bodies.circle(300, -32500, 100, {isStatic: false});
        this.body18 = Bodies.circle(1209, -34500, 100, {isStatic: false});
        this.body19 = Bodies.circle(875, -36500, 100, {isStatic: false});
        this.body20 = Bodies.circle(1447, -38500, 100, {isStatic: false});
        World.add(world, [this.body1, this.body2, this.body3, this.body4, this.body5, this.body6, this.body7, this.body8, this.body9, this.body10, this.body11, this.body12, this.body13, this.body14, this.body15, this.body16, this.body17, this.body18, this.body19, this.body20])
    }
